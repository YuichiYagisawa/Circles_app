...
class CirclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create circle" do
    assert_difference('Circle.count') do
      post circles_url, params: { circle: { circle_email: @circle.circle_email, circle_info: @circle.circle_info, circle_name: @circle.circle_name } }
    end
  ...
  test "should update circle" do
    patch circle_url(@circle), params: { circle: { circle_email: @circle.circle_email, circle_info: @circle.circle_info, circle_name: @circle.circle_name } }
